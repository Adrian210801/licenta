...
<body>
    ...
    <div class="div-content-principala">
       ...
       <aside class="sidebar">     
        ...
        <h1>AUTOMATICA ANUL 3 - Semestrul 2</H1>
        <div class="cursuri-blockuri-3">
        <a href="curs.php"><span class="cursuri">
            <img src="poze/curs.jpg" alt="descriere imagine" class="cursuri-image">
            <div class="curs-descriere">
                <div>Tehnici de diagnoza si diagnosticare</div>
                <div>Prof. Oana Calin</div>
            </div>
        </span></a>
        <a href="curs.php"><span class="cursuri">
            <img src="poze/curs.jpg" alt="descriere imagine" class="cursuri-image">
        ...
        <h1>AUTOMATICA ANUL 3 - Semestrul 1</H1>
        <div class="cursuri-blockuri-4">
        <a href="curs.php"><span class="cursuri">
            <img src="poze/curs.jpg" alt="descriere imagine" class="cursuri-image">
            <div class="curs-descriere">
                <div>Tehnici de diagnoza si diagnosticare</div>
        ...
        <h1>AUTOMATICA ANUL 2 - Semestrul 2</H1>
        <div class="cursuri-blockuri-1">    
        <a href="curs.php"><span class="cursuri">
            <img src="poze/curs.jpg" alt="descriere imagine" class="cursuri-image">
            <div class="curs-descriere">
        ...
        <h1>AUTOMATICA ANUL 2 - Semestrul 1</H1>
        <div class="cursuri-blockuri-1">    
        <a href="curs.php"><span class="cursuri">
            <img src="poze/curs.jpg" alt="descriere imagine" class="cursuri-image">
            <div class="curs-descriere">
        ...
        <h1>AUTOMATICA ANUL 1 - Semestrul 2</H1>
        <div class="cursuri-blockuri-1">    
        <a href="curs.php"><span class="cursuri">
            <img src="poze/curs.jpg" alt="descriere imagine" class="cursuri-image">
            <div class="curs-descriere">
        ...
        <h1>AUTOMATICA ANUL 1 - Semestrul 1</H1>
        <div class="cursuri-blockuri-1">    
        <a href="curs.php"><span class="cursuri">
            <img src="poze/curs.jpg" alt="descriere imagine" class="cursuri-image">
            <div class="curs-descriere">
